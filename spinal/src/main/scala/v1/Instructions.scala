...
object Instructions {
  ...
  val RV32I = List(ADD, ADDI, AND, ANDI, AUIPC, BEQ, BGE, BGEU, BLT, BLTU, BNE, EBREAK, ECALL,
    FENCE, FENCE_TSO, JAL, JALR, LB, LBU, LH, LHU, LUI, LW, OR, ORI, PAUSE, SB, SBREAK, SCALL,
    SH, SLL, SLT, SLTI, SLTIU, SLTU, SRA, SRL, SUB, SW, XOR, XORI, SLLI)
  val RV64SHIFT = List(SLLI, SRLI, SRAI)
  val RV64I = RV32I ++ RV64SHIFT
}
